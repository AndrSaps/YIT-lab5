        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LiftingWeight = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    RouteStarted = table.Column<DateTime>(nullable: false),
                    RouteFinished = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupplyCode = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inventory_Factory_FactoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AudioRecordUrl = table.Column<string>(nullable: true),
                    OrderId = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AudioRecord", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AudioRecord_Order_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipmentLocationId = table.Column<long>(nullable: true),
                    ShipmentPrice = table.Column<decimal>(type: "decimal(10, 2)", nullable: false),
                    OrderId = table.Column<long>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Shipment_Location_ShipmentLocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Factory_LocationId",
                table: "Factory",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_Inventory_FactoryId",
                table: "Inventory",
                column: "FactoryId");
